            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-primary-800/50 rounded-2xl shadow-lg border-2 border-gold-500/20 p-8 mb-8">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-gold-500 to-gold-600 shadow-lg shadow-gold-500/20 rounded-xl flex items-center justify-center">
                            <Truck className="w-8 h-8 text-primary-900" />
                        </div>
                        <div>
                ...
                <div className="bg-primary-800/50 rounded-2xl shadow-lg border-2 border-gold-500/20 p-8 space-y-8">
                    ...
                    <section>
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Cobertura</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3 mt-6">Tiempos de Entrega</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Costos de Envío</h3>
                        <p className="text-gray-300 leading-relaxed mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Seguimiento de Pedido</h3>
                    ...
                    <section className="pt-8 border-t border-gray-200">
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Condiciones Generales</h3>
                        <p className="text-gray-300 leading-relaxed mb-4">
                        ...
                        <div className="bg-primary-700/50 border border-gold-500/20 rounded-lg p-6 space-y-3 mb-6">
                            <p className="text-gray-300">✓ El producto debe estar en su empaque original</p>
                            <p className="text-gray-300">✓ No debe haber sido usado ni mostrar señales de desgaste</p>
                            <p className="text-gray-300">✓ Debe incluir todos los accesorios y manuales</p>
                            <p className="text-gray-300">✓ Conservar etiquetas y empaques originales</p>
                        </div>

                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Motivos de Devolución</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Proceso de Devolución</h3>
                        <ol className="list-decimal list-inside space-y-3 text-gray-300 ml-4 mb-6">
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Reembolsos</h3>
                        <p className="text-gray-300 leading-relaxed mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-gold-400 mb-3">Cambios</h3>
                        <p className="text-gray-300 leading-relaxed">
                    ...
                    {/* Contacto */}
                    <section className="pt-8 border-t border-gray-200">
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">¿Necesitas Ayuda?</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                        ...
                        <div className="bg-primary-700/50 border border-gold-500/20 rounded-lg p-4 space-y-2">
                            ...
                            {settings?.contact_phone && (
                                <p className="text-gray-300">
                                    ...
                                    <a href={`https://wa.me/${settings.contact_phone.replace(/\D/g, '')}`} className="text-gold-400 hover:text-gold-300 underline">
                                        {settings.contact_phone}
                                    </a>
                                </p>
                            )}
