        ...
        <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 pt-20 sm:pt-24 md:pt-28 pb-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-primary-800/50 rounded-2xl shadow-lg border-2 border-gold-500/20 p-8 mb-8">
                    ...
                    <div className="bg-gold-500/10 border-l-4 border-gold-500 p-4 rounded">
                        <div className="flex items-start">
                            <AlertCircle className="w-5 h-5 text-gold-400 mt-0.5 mr-3 flex-shrink-0" />
                ...
                <div className="bg-primary-800/50 rounded-2xl shadow-lg border-2 border-gold-500/20 p-8 space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">1. Información General</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                            AMC Market es una plataforma de comercio electrónico operada por <strong className="text-gold-400">Renting AMC</strong>,
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">2. Uso del Sitio Web</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">3. Productos y Precios</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                            <strong className="text-gold-400">Disponibilidad:</strong> Todos los productos están sujetos a disponibilidad.
                            Nos reservamos el derecho de limitar las cantidades de compra y de descontinuar productos
                            en cualquier momento.
                        </p>
                        <p className="text-gray-300 leading-relaxed mb-4">
                            <strong className="text-gold-400">Precios:</strong> Los precios mostrados están en pesos colombianos (COP) e incluyen
                            IVA cuando aplique. Los costos de envío se calcularán al momento del checkout y varían
                            según la ubicación.
                        </p>
                        <p className="text-gray-300 leading-relaxed">
                            <strong className="text-gold-400">Errores:</strong> Nos reservamos el derecho de corregir cualquier error en
                            precios o descripciones de productos, incluso después de haber sido confirmado el pedido.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">4. Proceso de Compra</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">5. Métodos de Pago</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">6. Envíos y Entregas</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">7. Devoluciones y Reembolsos</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                            Consulta nuestra <a href="/politica-envios" className="text-gold-400 hover:text-gold-300 font-medium underline">Política de Envíos y Devoluciones</a> para
                            información detallada sobre cómo devolver productos y solicitar reembolsos.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">8. Propiedad Intelectual</h2>
                        <p className="text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">9. Limitación de Responsabilidad</h2>
                        <p className="text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">10. Modificaciones</h2>
                        <p className="text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">11. Ley Aplicable</h2>
                        <p className="text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gold-400 mb-4">12. Contacto</h2>
                        <p className="text-gray-300 leading-relaxed mb-4">
                            Si tienes preguntas sobre estos términos y condiciones, contáctanos:
                        </p>
                        <div className="bg-primary-700/50 rounded-lg p-4 space-y-2 border border-gold-500/20">
